            ...
            for f in files:
                ...
                for sentence in doc.yieldSentences():
                    ...
                    for positionAttrib in AttributeGenerator.yieldPositionAttributes(sentence):
                        logger.debug('position feature: %s',
                                     positionAttrib.attr)
...
class Tagger:
    def __init__(self, modelpath, ngramfile):
        ...
        self.features = ['ngrams', 'verbs', 'verbclass', 'verbpos',
                         'passive', 'triples', 'relations', 'positions']
    ...
    def getSentenceLabelsWithProbabilities(self, doc):
        ...
        def ngramFilter(l, n): return n in self.ngrams[l]
